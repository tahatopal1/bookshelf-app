...
public class AppMasterSessionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_main_page, R.id.nav_users, R.id.nav_users_not_approved)
    ...
    public void onBackPressed() {
        Toast.makeText(getApplicationContext(), R.string.cannot_go_main_page, Toast.LENGTH_LONG).show();
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.action_settings:
                Toast.makeText(getApplicationContext(), getString(R.string.cannot_arrange), Toast.LENGTH_LONG).show();
                return super.onOptionsItemSelected(item);

            case R.id.action_logout:
                startActivity(new Intent(AppMasterSessionActivity.this, MainActivity.class));
                return super.onOptionsItemSelected(item);
