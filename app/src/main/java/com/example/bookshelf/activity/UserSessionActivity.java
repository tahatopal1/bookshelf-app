...
public class UserSessionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_main_page, R.id.nav_shelf, R.id.nav_book, R.id.nav_book_not_approved)
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.action_settings:
                Intent intent = new Intent(UserSessionActivity.this, SignUpActivity.class);
            ...
            case R.id.action_logout:
                startActivity(new Intent(UserSessionActivity.this, MainActivity.class));
                return super.onOptionsItemSelected(item);
